...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    setMessage('');
    try {
      const res = await axios.post('https://slotswapper-backend-gmuu.onrender.com/api/auth/login', formData);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-blue-100 p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6 sm:p-10">
       ...
       <p className='text-center text-red-600'>Login may take a few moments due to server deployment.</p>
